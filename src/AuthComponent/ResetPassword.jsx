  ...
  return (
    <section className="h-[100%] w-[100%]  bg-amber-500 flex justify-center items-center">
      <article className="h-[500px] w-[400px] bg-white rounded-md shadow-md p-[20px]">
        <header>
          <h1 className="text-center text-3xl m-2">Reset Password</h1>
        </header>
        <main>
          <form action="" className="flex flex-col gap-3 ">
           ...
           <div> 
             <button className="w-[100%] bg-[#2666fc]  text-[white] py-[7px] rounded-md cursor-pointer bg-[#0b52f8]">Forget password</button>
           </div>
          </form>
        </main>
        <footer className="mt-[10px] cursor-pointer m-2">
          <NavLink to={"/Login"}> Already Know Password ?</NavLink>
          <NavLink className={"text-red-600"} to={"/Register"}> Dont't Have an Account ?</NavLink>
        </footer>
      </article>
    </section>
  );
